                                    ...
                                    <div className="content-block-body">
                                        <div className="form-wrapper create-report-form">
                                            <form>
                                                <div className="form-group form-report">
                                                    <label><i className="icon-campaign"></i>Select a campaign</label>
                                                ...
                                                <div className="form-group form-report">
                                                    <label><i className="icon-calendar"></i>Select date range</label>
                                        ...
                                        <div className="form-wrapper">
                                            <div className="form-group form-report result-block">
                                                <label><i className="icon-signal"></i>Your report is ready</label>
